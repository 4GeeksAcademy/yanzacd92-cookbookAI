...
export const CreateRecipe = () => {
  ...
  async function createRecipe(e) {
    ...
    console.log("RECIPE IMAGE    " + formFields['recipePicture'])
    ...
    if (formFields['recipePicture'].files.length > 0) {
      ...
      if(resp_firebase.code >= 400) {
        swal("Opps!", "The image has problems, do not worry!!! we have created your recipe but without any picture", "warning");
        navigate("/recipeDetail/" + new_recipe.data.id)
      } else {
        ...
        <div className="cnt-create-recipe container mt-4 mb-4" id="form-create-recipe-id">
          ...
          <h1 className="login-title">Your Ingredients</h1>
            ...
            <div className="mb-3">
              ...
              <input className="form-control" type="file" name="recipePicture" id="formFile" />
            </div>
